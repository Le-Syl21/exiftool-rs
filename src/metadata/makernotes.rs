...
fn canon_custom2_name(id: u32) -> &'static str {
    match id {
        ...
        // Perl Functions2 hex IDs (0x02xx-0x20xx range)
        0x0257 => "ExposureLevelIncrements", 0x0260 => "AEBAutoCancel",
        0x0261 => "AEBSequence", 0x0262 => "AEBShotCount",
        0x0265 => "UsableShootingModes", 0x0266 => "UsableMeteringModes",
        0x0270 => "ApplyShootingMeteringMode",
        0x0271 => "FlashSyncSpeedAv", 0x0269 => "ApertureRange",
        0x0268 => "ShutterSpeedRange", 0x0264 => "SafetyShift",
        0x0513 => "LongExposureNoiseReduction", 0x0514 => "HighISONoiseReduction",
        0x0515 => "HighlightTonePriority",
        0x0772 => "ETTLII", 0x0773 => "ShutterCurtainSync", 0x0774 => "FlashFiring",
        0x1282 => "AIServoTrackingSensitivity", 0x1283 => "AIServoImagePriority",
        0x1284 => "AIServoTrackingMethod", 0x1285 => "LensDriveNoAF",
        0x1286 => "LensAFStopButton", 0x1287 => "AFMicroadjustment",
        0x1288 => "AFPointAreaExpansion", 0x1289 => "SelectableAFPoint",
        0x1290 => "SwitchToRegisteredAFPoint", 0x1291 => "AFPointAutoSelection",
        0x1292 => "AFPointDisplayDuringFocus", 0x1293 => "AFPointBrightness",
        0x1294 => "AFAssistBeam", 0x1295 => "AFPointSelectionMethod",
        0x1281 => "USMLensElectronicMF",
        0x1551 => "MirrorLockup", 0x1552 => "ContinuousShootingSpeed",
        0x1553 => "ContinuousShotLimit",
        0x1794 => "AFOnAELockButtonSwitch", 0x1795 => "QuickControlDialInMeter",
        0x1796 => "SetButtonWhenShooting", 0x1798 => "DialDirectionTvAv",
        0x1799 => "AvSettingWithoutLens", 0x1800 => "WBMediaImageSizeSetting",
        0x1801 => "LockMicrophoneButton", 0x1802 => "ButtonFunctionControlOff",
        0x1797 => "ManualTv",
        0x2059 => "FocusingScreen", 0x2060 => "TimerLength",
        0x2061 => "ShortReleaseTimeLag",
        0x2062 => "AddAspectRatioInfo", 0x2063 => "AddOriginalDecisionData",
        0x2064 => "LiveViewExposureSimulation",
        0x1031 => "ViewInfoDuringExposure", 0x1032 => "LCDIlluminationDuringBulb",
        0x1033 => "InfoButtonWhenShooting",
        _ => "",
    }
}
