...
static IFD0_TAGS: &[TagInfo] = &[
    ...
    TagInfo { tag_id: 0x828D, name: "CFARepeatPatternDim", description: "CFA Repeat Pattern Dim", family2: "Image" },
    TagInfo { tag_id: 0x828E, name: "CFAPattern2", description: "CFA Pattern 2", family2: "Image" },
    ...
    TagInfo { tag_id: 0x9216, name: "TIFF-EPStandardID", description: "TIFF-EP Standard ID", family2: "Image" },
