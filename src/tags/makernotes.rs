...
pub fn lookup(manufacturer: Manufacturer, tag_id: u16) -> (&'static str, &'static str) {
    ...
    let gen_table = match manufacturer {
        ...
        // Same gate as Canon above, for the same reason. NikonOld reads
        // `%Nikon::Type2` (Nikon.pm), a different table, so it is left alone.
        Manufacturer::Nikon if NIKON_MAIN_IDS.binary_search(&tag_id).is_ok() => {
            Some(super::generated::GENERATED_NIKON_TAGS)
        }
        Manufacturer::Nikon => None,
        Manufacturer::NikonOld => Some(super::generated::GENERATED_NIKON_TAGS),
...
/// Tag IDs defined by `%Image::ExifTool::Nikon::Main` (Nikon.pm), sorted.
/// Same problem as Canon: the merged generated table also carries the entries of
/// tables that are not the maker note's main IFD at all — `Nikon::MOV` alone
/// contributes `0xaf => 'Software'` (Nikon.pm:12292), which `%Nikon::Main` does
/// not define, so a Nikon IFD holding an unknown 0x00af came out as Software.
#[rustfmt::skip]
static NIKON_MAIN_IDS: &[u16] = &[
    0x0001, 0x0002, 0x0003, 0x0004, 0x0005, 0x0006, 0x0007, 0x0008, 0x0009, 0x000b, 0x000c, 0x000d,
    0x000e, 0x000f, 0x0010, 0x0011, 0x0012, 0x0013, 0x0014, 0x0016, 0x0017, 0x0018, 0x0019, 0x001a,
    0x001b, 0x001c, 0x001d, 0x001e, 0x001f, 0x0020, 0x0021, 0x0022, 0x0023, 0x0024, 0x0025, 0x002a,
    0x002b, 0x002c, 0x0032, 0x0034, 0x0035, 0x0037, 0x0039, 0x003d, 0x003e, 0x003f, 0x0044, 0x0045,
    0x004e, 0x004f, 0x0051, 0x0056, 0x0080, 0x0081, 0x0082, 0x0083, 0x0084, 0x0085, 0x0086, 0x0087,
    0x0088, 0x0089, 0x008b, 0x008c, 0x008d, 0x008f, 0x0090, 0x0091, 0x0092, 0x0093, 0x0094, 0x0095,
    0x0096, 0x0097, 0x0098, 0x0099, 0x009a, 0x009c, 0x009d, 0x009e, 0x00a0, 0x00a2, 0x00a5, 0x00a6,
    0x00a7, 0x00a8, 0x00a9, 0x00aa, 0x00ab, 0x00ac, 0x00ad, 0x00b0, 0x00b1, 0x00b3, 0x00b6, 0x00b7,
    0x00b8, 0x00b9, 0x00bb, 0x00bd, 0x00bf, 0x00c3, 0x0e00, 0x0e01, 0x0e09, 0x0e0e, 0x0e10, 0x0e13,
    0x0e1d, 0x0e1e, 0x0e22,
];
