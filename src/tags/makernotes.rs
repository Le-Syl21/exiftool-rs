...
static SONY_TAGS: &[(u16, &str, &str)] = &[
    ...
    (0x201C, "AFAreaModeSetting", "AF Area Mode Setting"),
    (0x2020, "AFPointsUsed", "AF Points Used"),
    ...
    (0xB04E, "FocusMode", "Focus Mode"),
    (0xB04F, "DynamicRangeOptimizer", "Dynamic Range Optimizer"),
    (0xB050, "HighISONoiseReduction2", "High ISO NR 2"),
    (0xB052, "IntelligentAuto", "Intelligent Auto"),
    (0xB054, "WhiteBalance", "White Balance"),
];
